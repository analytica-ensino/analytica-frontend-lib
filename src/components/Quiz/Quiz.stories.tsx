      ...
      questions: [
        {
          ...
          examBoard: 'ENEM',
          examYear: '2024',
          solutionExplanation: 'Brasília é a capital do Brasil desde 1960, quando foi inaugurada para substituir o Rio de Janeiro como sede do governo federal. A cidade foi planejada pelo arquiteto Oscar Niemeyer e pelo urbanista Lúcio Costa, seguindo princípios modernistas de arquitetura e urbanismo.',
          answer: null,
        ...
        },
        {
          ...
          examBoard: 'ENEM',
          examYear: '2024',
          solutionExplanation: 'Verdadeiro. A Terra é o terceiro planeta do sistema solar, localizada entre Vênus (segundo) e Marte (quarto). A ordem dos planetas a partir do Sol é: Mercúrio, Vênus, Terra, Marte, Júpiter, Saturno, Urano e Netuno.',
          answer: null,
          answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
          options: [
        ...
        },
        {
          ...
          examBoard: 'ENEM',
          examYear: '2024',
          solutionExplanation: 'Velocidade é a distância percorrida por unidade de tempo (v = d/t). Aceleração é a variação da velocidade por unidade de tempo (a = Δv/t). Estas são grandezas fundamentais da cinemática que descrevem o movimento dos corpos.',
          answer: null,
          answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
          options: [
      ...
      questions: [
        ...
        // ALTERNATIVE - Incorrect
        {
                 ...
                 // MULTIPLE CHOICE - Incorrect
         {
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'Velocidade, Aceleração e Força são grandezas vetoriais. Temperatura é uma grandeza escalar.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [
             { id: 'opt1', option: 'Velocidade' },
         ...
         {
           id: 'q7-vf-correta',
           questionText: 'A Terra é o terceiro planeta do sistema solar em ordem de distância do Sol.',
           questionType: QUESTION_TYPE.VERDADEIRO_FALSO,
           difficultyLevel: QUESTION_DIFFICULTY.FACIL,
                 ...
                 // True or False - Incorrect
         {
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'Falso. O Sol é uma estrela anã amarela (sequência principal). As anãs brancas são estrelas que já esgotaram seu combustível nuclear e são muito menores e mais densas.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [
             { id: 'opt1', option: 'Verdadeiro' },
  ...
  useEffect(() => {
    const mockSimulated = {
      ...
      questions: [
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'A resposta correta é a primeira opção porque ela representa corretamente o conceito físico abordado na questão. Em física, é fundamental entender os princípios básicos que governam os fenômenos naturais.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'As duas primeiras opções são corretas porque ambas representam soluções válidas para o problema matemático apresentado. Em matemática, é comum que uma equação tenha múltiplas soluções válidas.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [
             { id: 'opt1', option: 'Resposta correta' },
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'A química é uma ciência fundamental que estuda a composição, estrutura e propriedades da matéria. Ela é essencial para entender diversos fenômenos naturais e tecnológicos, desde a fotossíntese até a produção de medicamentos. A química está presente em todos os aspectos da vida moderna, incluindo agricultura, medicina, indústria e meio ambiente.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [],
           knowledgeMatrix: [
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'A terceira opção é a resposta correta porque representa o conceito biológico correto abordado na questão. Em biologia, é essencial compreender os processos celulares e suas funções no organismo.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [
           ...
           examBoard: 'ENEM',
           examYear: '2024',
           solutionExplanation: 'A segunda opção é a resposta correta porque representa o fato histórico correto sobre o período colonial brasileiro. Em história, é fundamental conhecer os eventos e contextos que moldaram a formação do país.',
           answer: null,
           answerStatus: QUESTION_STATUS.RESPOSTA_CORRETA,
           options: [
             { id: 'opt1', option: 'Resposta incorreta' },
