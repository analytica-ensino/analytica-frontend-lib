...
/**
 * Story para demonstrar variantes do QuizDissertative
 */
export const QuizDissertativeVariants: Story = () => {
  const {
    setBySimulated,
    startQuiz,
    setUserId,
  ...
  useEffect(() => {
    // Dados de exemplo para demonstrar as variantes dissertativas
    const mockSimulado = {
      id: 'simulado-dissertativo-variants',
      title: 'Simulado ENEM 2024 - Variantes Dissertativas',
      category: 'Enem',
      questions: [
        {
          id: 'q1',
    ...
    // Configurar respostas para demonstrar diferentes status
    setUserAnswers([
      {
        questionId: 'q1',
        activityId: 'simulado-dissertativo-variants',
        userId: 'demo-user-id',
        answer:
          'As redes sociais têm um impacto significativo na formação da opinião pública contemporânea. Elas democratizaram o acesso à informação, mas também criaram bolhas de filtro que podem polarizar a sociedade. É fundamental desenvolver o pensamento crítico para navegar neste ambiente digital.',
        optionId: null,
        questionType: QUESTION_TYPE.DISSERTATIVA,
        answerStatus: ANSWER_STATUS.PENDENTE_AVALIACAO,
      },
  ...
  return (
    <div className="space-y-12 h-[calc(100vh-180px)]">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold text-text-900 mb-4">
          Variantes do Quiz Dissertativo
        </h1>
        <p className="text-text-600 text-lg">
          Demonstração das diferentes variantes do componente dissertativo
        </p>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Variante Default - Pendente de Avaliação */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-text-900">
            Default - Pendente
          </h2>
          <div className="border rounded-lg p-6 bg-white">
            <QuizDissertative variant="default" />
          </div>
        </div>

        {/* Variante Result - Resposta Correta */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-text-900">Result - Correta</h2>
          <div className="border rounded-lg p-6 bg-white">
            <QuizDissertative variant="result" />
          </div>
        </div>

        {/* Variante Result - Resposta Incorreta */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-text-900">
            Result - Incorreta
          </h2>
...
/**
 * Story para demonstrar respostas corretas do QuizDissertative
 */
export const QuizDissertativeCorrectAnswer: Story = () => {
  const {
    setBySimulated,
    startQuiz,
    setUserId,
  ...
  useEffect(() => {
    const mockSimulado = {
      id: 'simulado-dissertativo-correct',
      title: 'Simulado ENEM 2024 - Resposta Correta',
      category: 'Enem',
      questions: [
        {
          id: 'q1',
    ...
    setUserAnswers([
      {
        questionId: 'q1',
        activityId: 'simulado-dissertativo-correct',
        userId: 'demo-user-id',
        answer:
          'As redes sociais revolucionaram a forma como a opinião pública é formada na contemporaneidade. Por um lado, democratizaram o acesso à informação, permitindo que diferentes vozes sejam ouvidas. Por outro, criaram algoritmos que podem reforçar preconceitos e criar bolhas de filtro. É essencial desenvolver o pensamento crítico para navegar neste ambiente digital de forma consciente e responsável.',
        optionId: null,
        questionType: QUESTION_TYPE.DISSERTATIVA,
        answerStatus: ANSWER_STATUS.RESPOSTA_CORRETA,
      },
  ...
  return (
    <div className="space-y-12 h-[calc(100vh-180px)]">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold text-text-900 mb-4">
          Quiz Dissertativo - Resposta Correta
        </h1>
        <p className="text-text-600 text-lg">
          Demonstração de uma resposta dissertativa avaliada como correta
        </p>
      </div>
...
/**
 * Story para demonstrar respostas incorretas do QuizDissertative
 */
export const QuizDissertativeIncorrectAnswer: Story = () => {
  const {
    setBySimulated,
    startQuiz,
    setUserId,
  ...
  useEffect(() => {
    const mockSimulado = {
      id: 'simulado-dissertativo-incorrect',
      title: 'Simulado ENEM 2024 - Resposta Incorreta',
      category: 'Enem',
      questions: [
        {
          id: 'q1',
    ...
    // Configurar resposta incorreta
    setUserAnswers([
      {
        questionId: 'q1',
        activityId: 'simulado-dissertativo-incorrect',
        userId: 'demo-user-id',
        answer:
          'Redes sociais são legais. Eu uso muito Instagram e TikTok. Tem muita coisa interessante lá. As pessoas postam fotos e vídeos. É muito divertido.',
        optionId: null,
        questionType: QUESTION_TYPE.DISSERTATIVA,
        answerStatus: ANSWER_STATUS.RESPOSTA_INCORRETA,
      },
  ...
  return (
    <div className="space-y-12 h-[calc(100vh-180px)]">
      ...
      <div className="text-center">
        <h1 className="text-4xl font-bold text-text-900 mb-4">
          Quiz Dissertativo - Resposta Incorreta
        </h1>
        <p className="text-text-600 text-lg">
          Demonstração de uma resposta dissertativa avaliada como incorreta
        </p>
      </div>
