...
export type AccessibilityFabPosition = 'right' | 'left';

const POSITION_CLASSES: Record<AccessibilityFabPosition, string> = {
  right: 'right-0 rounded-l-lg',
  left: 'left-0 rounded-r-lg',
};

/** Tooltip aparece do lado oposto à borda em que o FAB está colado */
const TOOLTIP_POSITION: Record<AccessibilityFabPosition, 'left' | 'right'> = {
  right: 'left',
  left: 'right',
};
