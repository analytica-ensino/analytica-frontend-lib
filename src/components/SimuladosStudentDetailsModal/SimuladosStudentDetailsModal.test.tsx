...
jest.mock('./useSimuladosStudentDetails', () => ({
...
function renderModal(overrides: Partial<SimuladosStudentDetailsModalProps> = {}) {
  const defaultProps: SimuladosStudentDetailsModalProps = {
    api: { post: jest.fn() },
    isOpen: true,
    onClose: jest.fn(),
  ...
  return render(<SimuladosStudentDetailsModal {...defaultProps} {...overrides} />);
}

describe('SimuladosStudentDetailsModal', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    mockHookState = {
      data: null,
