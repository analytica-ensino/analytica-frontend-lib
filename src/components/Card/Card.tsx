  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={`
          w-full flex bg-background border border-border-50 rounded-xl
  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={`
          w-full flex border bg-background border-border-50 rounded-xl min-h-20 flex-row items-center pr-4
          ${className}
        `}
        {...props}
      >
