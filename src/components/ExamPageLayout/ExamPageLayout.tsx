...
export interface ExamPageLayoutProps<T extends Record<string, unknown>> {
  ...
  /** Callback when the create exam button is clicked */
  onCreateExam: () => void;
}

/**
 * Shared layout component for exam pages (History, Drafts, Models).
