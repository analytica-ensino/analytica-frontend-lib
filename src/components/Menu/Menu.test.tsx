...
describe('MenuOverflow', () => {
  ...
  describe('Menu2 Responsive Width', () => {
    it('applies w-fit class when there is only one MenuItem', () => {
      render(
        <Menu defaultValue="single" variant="menu2">
          <MenuContent variant="menu2">
            <MenuItem value="single" variant="menu2" data-testid="single-item">
              Single Item
            </MenuItem>
          </MenuContent>
        </Menu>
      ...
      expect(singleItem).toHaveClass('w-fit');
      expect(singleItem).not.toHaveClass('w-full');
    });

    it('applies w-full class when there are multiple MenuItems', () => {
      render(
        <Menu defaultValue="item1" variant="menu2">
          <MenuContent variant="menu2">
            <MenuItem value="item1" variant="menu2" data-testid="item-1">
              Item 1
            </MenuItem>
            <MenuItem value="item2" variant="menu2" data-testid="item-2">
              Item 2
            </MenuItem>
            <MenuItem value="item3" variant="menu2" data-testid="item-3">
              Item 3
            </MenuItem>
          </MenuContent>
        </Menu>
      ...
      expect(item1).toHaveClass('w-full');
      expect(item2).toHaveClass('w-full');
      expect(item3).toHaveClass('w-full');
      expect(item1).not.toHaveClass('w-fit');
      expect(item2).not.toHaveClass('w-fit');
      expect(item3).not.toHaveClass('w-fit');
    });

    it('only applies responsive width logic to menu2 variant', () => {
      render(
        <Menu defaultValue="item1">
          <MenuContent>
            <MenuItem value="item1" variant="menu" data-testid="menu-item">
              Item 1
            </MenuItem>
          </MenuContent>
        </Menu>
      ...
      expect(menuItem).not.toHaveClass('w-fit');
    });

    it('works correctly with MenuOverflow component', () => {
      render(
        <MenuOverflow defaultValue="item1">
          <MenuItem value="item1" variant="menu2" data-testid="overflow-item-1">
            Item 1
          </MenuItem>
          <MenuItem value="item2" variant="menu2" data-testid="overflow-item-2">
            Item 2
          </MenuItem>
        </MenuOverflow>
      );

      const item1 = screen.getByTestId('overflow-item-1');
      const item2 = screen.getByTestId('overflow-item-2');
