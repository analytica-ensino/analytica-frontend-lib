  ...
  '2': {
    ...
    selectedQuestions: [
      ...
      },
      {
        ...
        options: [
          { id: 'opt17', option: 'Produzir energia', isCorrect: false },
          { id: 'opt18', option: 'Decompor matéria orgânica', isCorrect: true },
          { id: 'opt19', option: 'Caçar outros animais', isCorrect: false },
          { id: 'opt20', option: 'Realizar fotossíntese', isCorrect: false },
        ],
      },
    ],
  },
