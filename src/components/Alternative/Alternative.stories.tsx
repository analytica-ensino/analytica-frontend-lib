            ...
            alternatives={[
              {
                ...
                description:
                  'Esta é uma descrição detalhada da primeira opção, explicando os conceitos e implicações da escolha.',
              },
              {
                value: 'int-det-2',
                label: 'Análise Completa - Segunda Opção',
                description:
                  'Descrição da segunda alternativa com informações complementares sobre o tema abordado.',
              },
              {
                value: 'int-det-3',
                label: 'Análise Completa - Terceira Opção',
                description:
                  'Uma alternativa neutra com explicações sobre sua relevância no contexto da questão.',
              },
              {
                value: 'int-det-4',
                label: 'Análise Completa - Quarta Opção',
                description:
                  'Esta opção está desabilitada para demonstração do estado inativo.',
                disabled: true,
              },
            ]}
          />
            ...
            alternatives={[
              {
                ...
                description:
                  'Esta era a resposta correta. Mostra o badge de resposta correta mas o radio não está selecionado.',
                status: 'correct',
              },
              {
                ...
                description:
                  'Opção neutra que não foi selecionada pelo usuário.',
              },
              {
                value: 'detailed-user-wrong',
                label: 'Análise Detalhada - Opção C',
                description:
                  'Esta foi a escolha do usuário, mas estava incorreta. Radio selecionado + badge de resposta incorreta.',
              },
              {
            ...
            alternatives={[
              {
                ...
                label: 'Primeira Alternativa',
                description:
                  'Esta é a primeira alternativa disponível para seleção.',
              },
              {
                value: 'mixed-2',
                label: 'Segunda Alternativa',
                description:
                  'Esta é a segunda alternativa com descrição detalhada.',
              },
              {
                value: 'mixed-3',
                label: 'Terceira Alternativa',
                description:
                  'Esta alternativa demonstra o comportamento padrão do componente.',
              },
              {
                value: 'mixed-4',
                label: 'Alternativa Desabilitada',
                description:
                  'Esta alternativa está desabilitada e não pode ser selecionada.',
                disabled: true,
              },
            ]}
          />
