    ...
    selectedQuestions: [
      {
        ...
        options: [
          { id: 'opt1', option: 'Uma matriz 2x2', isCorrect: true },
          { id: 'opt2', option: 'Uma matriz 4x4', isCorrect: false },
          { id: 'opt3', option: 'Um vetor', isCorrect: false },
          { id: 'opt4', option: 'Um escalar', isCorrect: false },
        ],
      },
      {
        id: 'q2',
        ...
        options: [
          { id: 'opt5', option: 'Um vetor com magnitude 1', isCorrect: true },
          {
            id: 'opt6',
            option: 'Um vetor com componentes iguais',
            isCorrect: false,
          },
          { id: 'opt7', option: 'Um vetor nulo', isCorrect: false },
          { id: 'opt8', option: 'Um vetor perpendicular', isCorrect: false },
        ],
      },
    ],
  },
    ...
    selectedQuestions: [
      {
        ...
        options: [
          { id: 'opt9', option: 'Clorofila', isCorrect: true },
          { id: 'opt10', option: 'Caroteno', isCorrect: false },
          { id: 'opt11', option: 'Xantofila', isCorrect: false },
          { id: 'opt12', option: 'Hemoglobina', isCorrect: false },
        ],
      },
      {
        id: 'q4',
        ...
        options: [
          { id: 'opt13', option: 'Glicose', isCorrect: true },
          { id: 'opt14', option: 'Oxigênio', isCorrect: true },
          { id: 'opt15', option: 'Dióxido de carbono', isCorrect: false },
          { id: 'opt16', option: 'Água', isCorrect: false },
        ],
      },
    ],
  },
