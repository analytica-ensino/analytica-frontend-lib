...
/**
 * Loading skeleton component for RecommendedLessonCreate page
 *
    ...
    >
      ...
      <div className="w-full h-[80px] flex flex-row items-center justify-between px-6 gap-3 flex-shrink-0">
        ...
        <section className="flex flex-col gap-0.5 w-full">
          ...
          <SkeletonText width={450} height={16} />
        </section>
      </div>
      ...
      <div className="flex flex-row w-full flex-1 overflow-hidden gap-5 min-h-0">
        ...
        {/* Second Column - Lesson List Skeleton */}
        ...
        {/* Third Column - Lesson Preview Skeleton */}
        <div className="w-[400px] flex-shrink-0 overflow-hidden h-full min-h-0 p-4">
          <div className="flex flex-col gap-4 h-full">
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-3 flex-1 overflow-auto">
              {[1, 2, 3].map((i) => (
                ...
                >
                  <SkeletonText lines={1} spacing="small" />
