/**
 * Types for Simulados Filters Modal
 */
...
/**
 * Props for SimuladosFiltersModal component
 */
export interface SimuladosFiltersModalProps {
  /** Whether the modal is open */
  isOpen: boolean;
  /** Callback when modal is closed */
  onClose: () => void;
  /** Callback when filters are applied */
  onApply: (filters: SimuladosFilters) => void;
