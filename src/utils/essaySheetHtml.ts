...
export function buildEssaySheetPage(
  ...
  return `
  <div class="cartao" style="background:white;width:210mm;min-height:297mm;box-shadow:0 10px 15px -3px rgba(0,0,0,0.1);border:1px solid #d1d5db;padding:24px;font-size:11px;line-height:1.3;color:#000;">
    ...
    <div style="border:1px solid #9ca3af;margin-top:4px;padding:6px;">
      ...
      <div style="min-height:18px;font-size:11px;">${studentName ?? ''}</div>
    </div>
